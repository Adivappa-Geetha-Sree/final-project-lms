export let navList = [
    {
        id: 1,
        navName: "Course",
        icon: (<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="book" class="w-auto h-5 svg-inline--fa fa-book " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        subMenu: [
            { navName: "Add Course", link: "/Courses/Add" },
            { navName: "View Course", link: "/Courses/View" },
        ],
    },
    {
        id: 2,
        navName: "Video",
        icon: (<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="video" class="w-auto h-5 svg-inline--fa fa-video " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        subMenu: [
            { navName: "Add Video", link: "/Video/Add" },
            { navName: "View Video", link: "/Video/View" },
        ],
    },
    {
        id: 3,
        navName: "Slide",
        icon: (<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sliders" class="w-auto h-5 svg-inline--fa fa-sliders " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        subMenu: [
            { navName: "Add Slide", link: "/Slider/Add" },
            { navName: "View Slide", link: "/Slider/View" },
        ],
    },
    {
        id: 4,
        navName: "Team",
        icon: (<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="people-group" class="w-auto h-5 svg-inline--fa fa-people-group " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        subMenu: [
            { navName: "Add Team", link: "/Team/Add" },
            { navName: "View Team", link: "/Team/View" },
        ],
    },
    {
        id: 5,
        navName: "User",
        icon: (<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="users" class="w-auto h-5 svg-inline--fa fa-users " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        subMenu: [
            { navName: "View User", link: "/User/View" },
