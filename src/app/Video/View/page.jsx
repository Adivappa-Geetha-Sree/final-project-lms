...
export default function Veiwvideo() {
    ...
    let getCourses = () => {
        axios.get(`${apiBaseUrl}admin/video/view`)
            .then((res) => res.data)
            .then((finalres) => {
    ...
    let singDel = (id) => {
        axios.delete(`${apiBaseUrl}admin/video/delete/${id}`)
            .then((res) => {
                if (res.data.status) {
    ...
    let multiDel = () => {
        ...
        axios.post(`${apiBaseUrl}admin/video/muldelete/`, obj)
            .then((res) => {
        ...
        <>
            ...
            <div class="flex  bg-[#F5F7FF]">
                ...
                <div class=" w-[84%] relative px-[30px] py-[50px] h-[92vh] bg-[#F5F7FF]">
                    <h1 class="text-[25px] font-[500] mb-[10px]">Video Table</h1>
                    <div class="">
                            ...
                            <table class="w-full border border-gray-300">
                                <thead class="border border-gray-40-1 ">
                                    <tr class="border border-gray-40-1 ">
                                        ...
                                        <th className="border border-gray-400 px-4 py-2">Vedio Topic</th>
                                        <th className="border border-gray-400 px-4 py-2">Vieo Duration</th>
                                        <th className="border border-gray-400 px-4 py-2">Video Upload</th>
                                            ...
                                            course.map((value, index) => {
                                                return (
                                                    <tr class="border-1 " key={index}>
                                                        ...
                                                        <td className="border border-gray-400 px-4 py-2">{value.course_Name}</td>
                                                        <td className="border border-gray-400 px-4 py-2">{value.Video_Topic_Name}</td>
                                                        <td className="border border-gray-400 px-4 py-2">{value.Video_Duration}</td>
                                                        <td className="border border-gray-400 px-4 py-2">
                                                            <video className='w-16 h-16 rounded-md object-cover' src={apiBaseUrl + staticPath + value.Video_File}
                                                                alt="image.jgp" />
                                                        </td>
