...
//   href: '#',
//   breadcrumbs: [
//     { id: 1, name: 'Courses', href: '/Courses' },
//     { id: 2, name: '', href: '#' },
//   ],
//   images: [
//     {
...
export default function Slugpage() {
    ...
    axios.get(`${apiBaseUrl}web/home/Home_course/${id}`)
    // .then((res) => res.data)
    // .then((finalres) => {
                ...
                //   onChange={setSelectedColor} 
                  className="flex items-center gap-x-3">
                    {/* {product.colors.map((color) => ( */}
                      <Radio className='relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-hidden data-checked:ring-2 data-focus:data-checked:ring-3 data-focus:data-checked:ring-offset-1'
                        // key={color.name}
                        // value={color}
